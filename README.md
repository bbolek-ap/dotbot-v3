...
- **External notifications** — Real-time status updates to **Teams**, **Email**, or **Jira** as tasks progress. Optional DotbotServer relay for Adaptive Card-based interaction (see `server/`).
